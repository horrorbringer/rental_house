...
<div class="space-y-6">
    <!-- Header -->
    <div class="bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg shadow-lg p-6 mb-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('rooms.create') }}" class="bg-indigo-500 hover:bg-indigo-600 text-white font-medium py-2.5 px-4 rounded-lg transition-all duration-200 inline-flex items-center group shadow-lg hover:shadow-indigo-500/20">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <!-- Total Rooms -->
        <div class="bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm text-indigo-400 font-medium px-2.5 py-0.5 rounded-full bg-indigo-500/10">Total</span>
            </div>
            <div class="flex flex-col">
                <h4 class="text-2xl font-bold text-white mb-1">{{ $rooms->total() }}</h4>
        ...
        <div class="bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm text-green-400 font-medium px-2.5 py-0.5 rounded-full bg-green-500/10">Available</span>
            </div>
            <div class="flex flex-col">
                <h4 class="text-2xl font-bold text-white mb-1">{{ $rooms->where('status', App\Models\Room::STATUS_VACANT)->count() }}</h4>
        ...
        <div class="bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm text-red-400 font-medium px-2.5 py-0.5 rounded-full bg-red-500/10">Occupied</span>
            </div>
            <div class="flex flex-col">
                <h4 class="text-2xl font-bold text-white mb-1">{{ $rooms->where('status', App\Models\Room::STATUS_OCCUPIED)->count() }}</h4>
        ...
        <div class="bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm text-emerald-400 font-medium px-2.5 py-0.5 rounded-full bg-emerald-500/10">Revenue</span>
            </div>
            <div class="flex flex-col">
                <h4 class="text-2xl font-bold text-white mb-1">₱{{ number_format($rooms->sum('monthly_rent'), 2) }}</h4>
        ...
        <form action="{{ route('rooms.index') }}" method="GET" class="space-y-4" x-data="{ showFilters: false }">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="text-lg font-medium text-white">Search & Filters</h3>
                </div>
            ...
            <div x-show="showFilters" x-transition class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="space-y-2">
                    <label for="building_id" class="block text-sm font-medium text-gray-300">Building</label>
                    <select name="building_id" id="building_id" 
                            class="w-full rounded-lg bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 transition-shadow">
                ...
                <div class="flex items-end gap-3">
                    <button type="submit" class="flex-1 bg-indigo-500 hover:bg-indigo-600 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 inline-flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-indigo-500/20">
                    ...
                    @if(request()->has('building_id') || request()->has('status'))
                        <a href="{{ route('rooms.index') }}" 
                           class="bg-gray-600 hover:bg-gray-500 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 inline-flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-gray-600/20">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
