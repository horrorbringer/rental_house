...
<div class="space-y-6">
    <!-- Header -->
    <div class="bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-700 rounded-lg shadow-lg p-6 mb-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <!-- Total Rooms -->
        <div class="bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-700 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($rooms as $room)
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden group hover:ring-2 hover:ring-indigo-500 transition-all duration-200">
                <!-- Room Image -->
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <div class="flex items-start justify-between mb-1">
                            <div>
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Room {{ $room->room_number }}</h4>
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $room->building->name }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-400">Water Fee</span>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            <div class="flex items-center gap-3">
                                <div class="p-2 bg-yellow-100 dark:bg-yellow-500/10 rounded-lg">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-400">Electric Fee</span>
                            </div>
                    ...
                    @if($room->rental)
                        <div class="mt-6 p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Current Tenant</p>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ $room->rental->tenant->name }}</p>
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/20 border-t border-gray-200 dark:border-gray-700">
                    <div class="grid grid-cols-3 gap-3">
                        <a href="{{ route('rooms.show', $room) }}" 
                           class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                        ...
                        <a href="{{ route('rooms.edit', $room) }}" 
                           class="inline-flex items-center justify-center px-4 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 text-gray-900 dark:text-white text-sm font-medium rounded-lg transition-colors duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <form action="{{ route('rooms.destroy', $room) }}" 
                            ...
                            @method('DELETE')
                            <button type="submit" 
                                    class="w-full inline-flex items-center justify-center px-4 py-2 bg-red-50 hover:bg-red-100 dark:bg-red-500/10 dark:hover:bg-red-500/20 text-red-600 dark:text-red-500 text-sm font-medium rounded-lg transition-colors duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
