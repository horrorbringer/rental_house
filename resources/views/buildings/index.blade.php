        ...
        <div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="flex items-center gap-4">
                    <!-- Stats Summary -->
                    <div class="hidden md:grid grid-cols-3 gap-4 items-center bg-gray-900/50 rounded-lg px-4 py-2">
                        <div class="text-center px-4">
                            <span class="block text-2xl font-bold text-indigo-400">{{ $buildings->count() }}</span>
                            <span class="text-xs text-gray-400 uppercase tracking-wider">Buildings</span>
                        </div>
                        <div class="text-center px-4 border-l border-r border-gray-700">
                            <span class="block text-2xl font-bold text-emerald-400">{{ $buildings->sum('vacant_rooms_count') }}</span>
                            <span class="text-xs text-gray-400 uppercase tracking-wider">Available</span>
                        </div>
                        <div class="text-center px-4">
                            <span class="block text-2xl font-bold text-orange-400">{{ $buildings->sum('rooms_count') > 0 
                                ? round(($buildings->sum('rooms_count') - $buildings->sum('vacant_rooms_count')) / $buildings->sum('rooms_count') * 100) 
                                : 0 }}%</span>
                            <span class="text-xs text-gray-400 uppercase tracking-wider">Occupied</span>
                        </div>
                    </div>
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <div class="flex-1 min-w-[200px]">
                    ...
                    <div class="relative">
                        <input type="text" 
                               ...
                               class="w-full bg-gray-900/50 text-gray-200 rounded-lg pl-10 pr-4 py-2 focus:ring-2 focus:ring-indigo-500 border-gray-700"
                ...
                <div class="min-w-[150px]">
                    <select x-model="filter" 
                            ...
                            class="w-full bg-gray-900/50 text-gray-200 rounded-lg py-2 px-3 border-gray-700 focus:ring-2 focus:ring-indigo-500">
            ...
            <template x-if="!loading">
                <div class="space-y-4">
                    ...
                    <template x-for="building in filteredBuildings" :key="building.id">
                        <div class="bg-gray-800/50 rounded-xl overflow-hidden shadow-lg border border-gray-700/50"
