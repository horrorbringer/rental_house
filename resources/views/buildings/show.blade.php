...
<style>
    ...
    .stat-card {
        background: linear-gradient(to bottom right, rgba(75, 85, 99, 0.1), rgba(55, 65, 79, 0.1));
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="buildingDetails()">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
        <div class="stat-card rounded-xl p-6 border border-gray-700/50 hardware-accelerated">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-400">Total Rooms</p>
                    <h3 class="text-2xl font-bold text-white mt-1">{{ $building->rooms->count() }}</h3>
                </div>
                ...
                <div class="bg-gray-700/50 rounded-xl p-6 border border-gray-700/50">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="mt-1 text-white">{{ $building->owner->name }}</p>
                        </div>
                        <div>
                            <span class="text-sm text-gray-400">Contact Information</span>
                            <p class="mt-1 text-white">{{ $building->contact_info ?? 'Not provided' }}</p>
                        </div>
                        @if($building->description)
                            <div>
                                <span class="text-sm text-gray-400">Description</span>
                                <p class="mt-1 text-white">{{ $building->description }}</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-gray-700/50 rounded-xl p-6 border border-gray-700/50">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('rooms.create', ['building' => $building->id]) }}"
                           class="flex items-center justify-between w-full p-3 bg-gray-600/50 hover:bg-gray-600 rounded-lg group transition-all duration-200">
                            <span class="text-gray-200 group-hover:text-white">Add New Room</span>
                        ...
                        <a href="{{ route('utility-usages.index', ['building' => $building->id]) }}"
                           class="flex items-center justify-between w-full p-3 bg-gray-600/50 hover:bg-gray-600 rounded-lg group transition-all duration-200">
                            <span class="text-gray-200 group-hover:text-white">Manage Utilities</span>
                            <svg class="w-5 h-5 text-gray-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
